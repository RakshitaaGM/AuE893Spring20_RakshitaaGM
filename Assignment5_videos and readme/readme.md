...
In real world ,the yellow line in simulation world was not used. Instad A4 sheet was used. The camera topics that is being subscribed to was changed to raspicam_node/image_raw. 
...
Step 7:rqt_image_view - This command is used to view the video feed of the camera. Make sure that it has been changed to the right topic which : tag_detection_image

NOTE:
Do not connect run the bot on cell phone's mobile data because it did not work. 
